...
public class HistoryOrderUser {
    ...
    public HistoryOrderUser(String idHistoryUser, String idStore, String storeName, String linkPhotoStore, String phoneNumber, String address, String timeOrder, ArrayList<Flag_Product> arrProduct, int statusOrder) {
